...
export default async function VentasPage() {
  ...
  const { data, error } = await supabase
    .from("ventas_sii")
    .select(
      "id, tipo_doc, rut_cliente, razon_social, folio, fecha_emision, monto_neto, monto_exento, monto_total, forma_pago, term_pago_dias, fecha_vencimiento, fecha_vencimiento_manual, notas_venta(id, folio)"
    )
